...
export const Profile = () => {
  ...
  return (
       <>
        ...
        <div class="media">
        <div class="d-flex">
        <img src="img/xpersonal.jpg.pagespeed.ic.0nYDRDpxHl.webp" alt="" data-pagespeed-url-hash="2578213152" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"/>
        </div>
